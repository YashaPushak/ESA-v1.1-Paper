...
We obtained analagous results for the polynomial data set. 
...
%HH: <- let's make sure that we introduce the term 'target algorithm' for the algorithm whose performance we are investigating using ESA early in the paper, and then use it in places like this, where there may be ambiguity between the target algorithm and ESA itself. (TODO)
